...
@Component({
  standalone: true,
  imports: [],
  selector: 'app-tailwinds-email-subscribe-tl',
  templateUrl: './email-subscribe-tl.component.html',
  styleUrls: ['./email-subscribe-tl.component.scss']
})
export class EmailSubscribeTlComponent  {
