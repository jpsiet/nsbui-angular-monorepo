...
@Component({
   standalone: true,
    imports: [],
  selector: 'app-pricing-grid-tl-component',
  templateUrl: './pricing-grid-tl.component.html',
  styleUrls: ['./pricing-grid-tl.component.scss']
})
export class PriceGridTlComponent  {
